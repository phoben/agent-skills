...
CREATE TABLE [dbo].[业务移交记录表](
	...
	[原单据负责人] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
	[现单据负责人] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
	[移交需求单数量] [bigint] NULL,
	[移交备注] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
	[操作人] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
	[移交日期] [datetime] NULL,
