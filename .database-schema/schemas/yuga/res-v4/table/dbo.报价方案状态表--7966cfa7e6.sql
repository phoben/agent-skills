...
CREATE TABLE [dbo].[报价方案状态表](
	...
	[状态码] [bigint] NULL,
	[状态] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[报价方案状态表] ADD  CONSTRAINT [DK_报价方案状态表_f70819688e1743a5aa0570f2a637fef8]  DEFAULT ((-1)) FOR [状态码]
