...
CREATE TABLE [dbo].[日志表](
	[表名] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
	[主键] [nvarchar](500) COLLATE Chinese_PRC_CI_AS NULL,
	[返回码] [nvarchar](1000) COLLATE Chinese_PRC_CI_AS NULL,
	[返回值] [nvarchar](max) COLLATE Chinese_PRC_CI_AS NULL,
